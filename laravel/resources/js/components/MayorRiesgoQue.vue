<template>
  <div v-loading="loading">
    <el-divider>
      Pacientes ordenados por Urgencia (Riesgo). Mayor riesgo que HM Ingresada.
    </el-divider>
